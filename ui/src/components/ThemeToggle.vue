...
<template>
  <button @click="toggle" class="p-1.5 rounded hover:bg-white/10 transition-colors" title="Toggle theme">
    <!-- Sun icon (shown in dark mode) -->
    <svg v-if="isDark" class="w-4 h-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
